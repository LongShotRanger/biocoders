! function(e, t) {
    ...
    function T(e, t) {
        ...
        return (n && !i ? t.contains(a) : t === a && "BODY" !== a.nodeName) && (h = function(e, t) {
            var i = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
                n = g(t, "top"),
                r = g(t, "left"),
                o = i ? -1 : 1;
    ...
    function t(e, t, i, n) {
        ...
        return function e(t, i, n, r) {
            ...
            s.addEventListener(i, n, {
                passive: !0
            }), o || e(f(s.parentNode), i, n, r), r.push(s)
    ...
    function c(i, n) {
        Object.keys(n).forEach(function(e) {
            var t = ""; - 1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(e) && I(n[e]) && (t = "px"), i.style[e] = n[e] + t
        })
    }
    ...
    var N = M && window.Promise ? function(e) {
            var t = !1;
            return function() {
        ...
        J = function() {
            function o(e, t) {
                ...
                }, this.update = N(this.update.bind(this)), this.options = V({}, o.Defaults, n), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = e && e.jquery ? e[0] : e, this.popper = t && t.jquery ? t[0] : t, this.options.modifiers = {}, Object.keys(V({}, o.Defaults.modifiers, n.modifiers)).forEach(function(e) {
                ...
                value: function() {
                    return function() {
                        if (!this.state.isDestroyed) {
                            ...
                            e.offsets.reference = l(this.state, this.popper, this.reference, this.options.positionFixed), e.placement = a(this.options.placement, e.offsets.reference, this.popper, this.reference, this.options.modifiers.flip.boundariesElement, this.options.modifiers.flip.padding), e.originalPlacement = e.placement, e.positionFixed = this.options.positionFixed, e.offsets.popper = E(this.popper, e.offsets.reference, e.placement), e.offsets.popper.position = this.options.positionFixed ? "fixed" : "absolute", e = k(this.modifiers, e), this.state.isCreated ? this.options.onUpdate(e) : (this.state.isCreated = !0, this.options.onCreate(e))
                        }
                    }.call(this)
                }
            }, {
    ...
    return J.Utils = ("undefined" == typeof window ? global : window).PopperUtils, J.placements = U, J.Defaults = {
        placement: "bottom",
        positionFixed: !1,
        eventsEnabled: !0,
        removeOnDestroy: !1,
            ...
            offset: {
                ...
                fn: function(e, t) {
                    var i, n = t.offset,
                        ...
                        a = o.reference,
                        l = r.split("-")[0];
                    return i = I(+n) ? [+n, 0] : O(n, s, a, l), "left" === l ? (s.top += i[0], s.left -= i[1]) : "right" === l ? (s.top += i[0], s.left += i[1]) : "top" === l ? (s.left += i[0], s.top -= i[1]) : "bottom" === l && (s.left += i[0], s.top += i[1]), e.popper = s, e
                },
                offset: 0
            },
            preventOverflow: {
            ...
            flip: {
                ...
                fn: function(f, m) {
                    ...
                    return _.forEach(function(e, t) {
                        ...
                        (s || h || d) && (f.flipped = !0, (s || h) && (y = _[t + 1]), d && (b = "end" === (i = b) ? "start" : "start" === i ? "end" : i), f.placement = y + (b ? "-" + b : ""), f.offsets.popper = V({}, f.offsets.popper, E(f.instance.popper, f.offsets.reference, f.placement)), f = k(f.instance.modifiers, f, "flip"))
                    }), f
                },
                behavior: "flip",
                padding: 5,
            ...
            computeStyle: {
                ...
                fn: function(e, t) {
                    ...
                    var s, a, l = void 0 === o ? t.gpuAcceleration : o,
                        ...
                        f = Y("transform");
                    if (a = "bottom" == p ? -c.height + h.bottom : h.top, s = "right" == d ? -c.width + h.right : h.left, l && f) u[f] = "translate3d(" + s + "px, " + a + "px, 0)", u[p] = 0, u[d] = 0, u.willChange = "transform";
                    else {
                        var m = "bottom" == p ? -1 : 1,
                            g = "right" == d ? -1 : 1;
...
function(e, t) {
    ...
    var r, i, o, a, c, h, p, d, f, m, g, y, v, b, _, w, T, P, x, S, C, E, j, k, Y, I, A, O, Q, D, z, L, M, F, R, B, N, W, H, $, q, V, U, X, K, G, Z, J, ee, te, ie, ne, re, oe, se, ae, le, ce, ue, he, pe, de, fe, me, ge, ye, ve, be, _e, we, Te, Pe, xe, Se, Ce, Ee, je, ke, Ye, Ie, Ae, Oe, Qe, De, ze, Le, Me, Fe, Re, Be, Ne, We, He, $e, qe, Ve, Ue, Xe, Ke, Ge, Ze, Je, et, tt, it, nt, rt, ot, st, at, lt, ct, ut, ht, pt, dt, ft, mt, gt, yt, vt, bt, _t, wt, Tt, Pt, xt, St, Ct, Et = (St = "transitionend", Ct = {
            ...
            typeCheckConfig: function(e, t, i) {
                for (var n in i)
                    if (Object.prototype.hasOwnProperty.call(i, n)) {
                        var r = i[n],
                            o = t[n],
                            s = o && Ct.isElement(o) ? "element" : (a = o, {}.toString.call(a).match(/\s([a-z]+)/i)[1].toLowerCase());
            ...
            var t = this,
                i = !1;
            return xt(this).one(Ct.TRANSITION_END, function() {
                i = !0
            }), setTimeout(function() {
        ...
        jt = (i = "alert", a = "." + (o = "bs.alert"), c = (r = t).fn[i], h = {
            CLOSE: "close" + a,
            CLOSED: "closed" + a,
            ...
            return e.close = function(e) {
                ...
                if (r(t).removeClass("show"), r(t).hasClass("fade")) {
                    ...
                    r(t).one(Et.TRANSITION_END, function(e) {
        ...
        }(), r(document).on(h.CLICK_DATA_API, '[data-dismiss="alert"]', p._handleDismiss(new p)), r.fn[i] = p._jQueryInterface, r.fn[i].Constructor = p, r.fn[i].noConflict = function() {
            return r.fn[i] = c, p._jQueryInterface
        }, p),
        kt = (f = "button", g = "." + (m = "bs.button"), y = ".data-api", v = (d = t).fn[f], b = "active", "btn", _ = '[data-toggle^="button"]', '[data-toggle="buttons"]', "input", ".active", ".btn", w = {
        ...
        }(), d(document).on(w.CLICK_DATA_API, _, function(e) {
            e.preventDefault();
            var t = e.target;
        ...
        }), d.fn[f] = T._jQueryInterface, d.fn[f].Constructor = T, d.fn[f].noConflict = function() {
            return d.fn[f] = v, T._jQueryInterface
        }, T),
        Yt = (x = "carousel", C = "." + (S = "bs.carousel"), E = ".data-api", j = (P = t).fn[x], k = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
        ...
        }, "carousel", Q = "active", "slide", "carousel-item-right", "carousel-item-left", "carousel-item-next", "carousel-item-prev", ".active", D = ".active.carousel-item", ".carousel-item", ".carousel-item-next, .carousel-item-prev", ".carousel-indicators", "[data-slide], [data-slide-to]", '[data-ride="carousel"]', z = function() {
            function o(e, t) {
                this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(t), this._element = P(e)[0], this._indicatorsElement = this._element.querySelector(".carousel-indicators"), this._addEventListeners()
            }
            var e = o.prototype;
            return e.next = function() {
                ...
                P(this._element).off(C), P.removeData(this._element, S), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                ...
                this._config.keyboard && P(this._element).on(O.KEYDOWN, function(e) {
                    ...
                    return t.cycle(e)
                }), "ontouchstart" in document.documentElement && P(this._element).on(O.TOUCHEND, function() {
                ...
                if (e === I ? (i = "carousel-item-left", n = "carousel-item-next", r = "left") : (i = "carousel-item-right", n = "carousel-item-prev", r = "right"), l && P(l).hasClass(Q)) this._isSliding = !1;
                    ...
                    if (P(this._element).hasClass("slide")) {
                        ...
                        P(s).one(Et.TRANSITION_END, function() {
                            P(l).removeClass(i + " " + n).addClass(Q), P(s).removeClass(Q + " " + n + " " + i), o._isSliding = !1, setTimeout(function() {
        ...
        }(), P(document).on(O.CLICK_DATA_API, "[data-slide], [data-slide-to]", z._dataApiClickHandler), P(window).on(O.LOAD_DATA_API, function() {
            for (var e = [].slice.call(document.querySelectorAll('[data-ride="carousel"]')), t = 0, i = e.length; t < i; t++) {
                var n = P(e[t]);
                z._jQueryInterface.call(n, n.data())
            }
        }), P.fn[x] = z._jQueryInterface, P.fn[x].Constructor = z, P.fn[x].noConflict = function() {
            return P.fn[x] = j, z._jQueryInterface
        }, z),
        It = (M = "collapse", R = "." + (F = "bs.collapse"), B = (L = t).fn[M], N = {
            toggle: !0,
            parent: ""
        }, W = {
            toggle: "boolean",
        ...
        }, $ = "show", q = "collapse", V = "collapsing", U = "collapsed", "width", "height", ".show, .collapsing", X = '[data-toggle="collapse"]', K = function() {
            function a(t, e) {
            ...
            return e.toggle = function() {
                ...
                var e, t, i = this;
                if (!(this._isTransitioning || L(this._element).hasClass($) || (this._parent && 0 === (e = [].slice.call(this._parent.querySelectorAll(".show, .collapsing")).filter(function(e) {
                        return e.getAttribute("data-parent") === i._config.parent
                    })).length && (e = null), e && (t = L(e).not(this._selector).data(F)) && t._isTransitioning))) {
                    ...
                    if (L(this._element).trigger(n), !n.isDefaultPrevented()) {
                        ...
                        L(this._element).one(Et.TRANSITION_END, function() {
        ...
        }), L.fn[M] = K._jQueryInterface, L.fn[M].Constructor = K, L.fn[M].noConflict = function() {
            return L.fn[M] = B, K._jQueryInterface
        }, K),
        At = (Z = "dropdown", ee = "." + (J = "bs.dropdown"), te = ".data-api", ie = (G = t).fn[Z], ne = new RegExp("38|40|27"), re = {
            HIDE: "hide" + ee,
            HIDDEN: "hidden" + ee,
            SHOW: "show" + ee,
            SHOWN: "shown" + ee,
                    ...
                    if (c._clearMenus(), !t) {
                        ...
                        if (G(e).trigger(n), !n.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var r = this._element;
                                "parent" === this._config.reference ? r = e : Et.isElement(this._config.reference) && (r = this._config.reference, void 0 !== this._config.reference.jquery && (r = this._config.reference[0])), "scrollParent" !== this._config.boundary && G(e).addClass("position-static"), this._popper = new u(r, this._menu, this._getPopperConfig())
                            }
                            "ontouchstart" in document.documentElement && 0 === G(e).closest(".navbar-nav").length && G(document.body).children().on("mouseover", null, G.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), G(this._menu).toggleClass(se), G(e).toggleClass(se).trigger(G.Event(re.SHOWN, i))
                        }
                    }
                }
            }, e.dispose = function() {
                    ...
                    for (var t = [].slice.call(document.querySelectorAll(le)), i = 0, n = t.length; i < n; i++) {
                        ...
                        if (e && "click" === e.type && (s.clickEvent = e), o) {
                            ...
                            if (G(r).hasClass(se) && !(e && ("click" === e.type && /input|textarea/i.test(e.target.tagName) || "keyup" === e.type && 9 === e.which) && G.contains(r, e.target))) {
                                ...
                                G(r).trigger(l), l.isDefaultPrevented() || ("ontouchstart" in document.documentElement && G(document.body).children().off("mouseover", null, G.noop), t[i].setAttribute("aria-expanded", "false"), G(a).removeClass(se), G(r).removeClass(se).trigger(G.Event(re.HIDDEN, s)))
                            }
                        }
                    }
            }, c._getParentFromElement = function(e) {
                var t, i = Et.getSelectorFromElement(e);
                return i && (t = document.querySelector(i)), t || e.parentNode
            }, c._dataApiKeydownHandler = function(e) {
                if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || G(e.target).closest(ce).length)) : ne.test(e.which)) && (e.preventDefault(), e.stopPropagation(), !this.disabled && !G(this).hasClass(oe))) {
        ...
        }(), G(document).on(re.KEYDOWN_DATA_API, le, pe._dataApiKeydownHandler).on(re.KEYDOWN_DATA_API, ce, pe._dataApiKeydownHandler).on(re.CLICK_DATA_API + " " + re.KEYUP_DATA_API, pe._clearMenus).on(re.CLICK_DATA_API, le, function(e) {
            e.preventDefault(), e.stopPropagation(), pe._jQueryInterface.call(G(this), "toggle")
        }).on(re.CLICK_DATA_API, ".dropdown form", function(e) {
            e.stopPropagation()
        }), G.fn[Z] = pe._jQueryInterface, G.fn[Z].Constructor = pe, G.fn[Z].noConflict = function() {
            return G.fn[Z] = ie, pe._jQueryInterface
        }, pe),
        Ot = (fe = "modal", ge = "." + (me = "bs.modal"), ye = (de = t).fn[fe], ve = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
        ...
        }, "modal-scrollbar-measure", "modal-backdrop", we = "modal-open", Te = "fade", Pe = "show", ".modal-dialog", '[data-toggle="modal"]', '[data-dismiss="modal"]', xe = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", Se = ".sticky-top", Ce = function() {
            function r(e, t) {
            ...
            return e.toggle = function(e) {
                ...
                if (!this._isTransitioning && !this._isShown) {
                    ...
                    var i = de.Event(_e.SHOW, {
                        relatedTarget: e
                    });
                    de(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), de(document.body).addClass(we), this._setEscapeEvent(), this._setResizeEvent(), de(this._element).on(_e.CLICK_DISMISS, '[data-dismiss="modal"]', function(e) {
                        return t.hide(e)
                ...
                if (e && e.preventDefault(), !this._isTransitioning && this._isShown) {
                    ...
                    if (de(this._element).trigger(i), this._isShown && !i.isDefaultPrevented()) {
                        ...
                        if (n && (this._isTransitioning = !0), this._setEscapeEvent(), this._setResizeEvent(), de(document).off(_e.FOCUSIN), de(this._element).removeClass(Pe), de(this._element).off(_e.CLICK_DISMISS), de(this._dialog).off(_e.MOUSEDOWN_DISMISS), n) {
                            var r = Et.getTransitionDurationFromElement(this._element);
                            de(this._element).one(Et.TRANSITION_END, function(e) {
                ...
                de.removeData(this._element, me), de(window, document, this._element, this._backdrop).off(ge), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._scrollbarWidth = null
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || document.body.appendChild(this._element), this._element.style.display = "block", this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, i && Et.reflow(this._element), de(this._element).addClass(Pe), this._config.focus && this._enforceFocus();
                var n = de.Event(_e.SHOWN, {
                        relatedTarget: e
                    }),
                    r = function() {
                ...
                var t = this;
                de(document).off(_e.FOCUSIN).on(_e.FOCUSIN, function(e) {
                    document !== e.target && t._element !== e.target && 0 === de(t._element).has(e.target).length && t._element.focus()
                })
            }, e._setEscapeEvent = function() {
                var t = this;
                this._isShown && this._config.keyboard ? de(this._element).on(_e.KEYDOWN_DISMISS, function(e) {
                    27 === e.which && (e.preventDefault(), t.hide())
                }) : this._isShown || de(this._element).off(_e.KEYDOWN_DISMISS)
            }, e._setResizeEvent = function() {
                var t = this;
                this._isShown ? de(window).on(_e.RESIZE, function(e) {
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && this._backdrop.classList.add(i), de(this._backdrop).appendTo(document.body), de(this._element).on(_e.CLICK_DISMISS, function(e) {
                            t._ignoreBackdropClick ? t._ignoreBackdropClick = !1 : e.target === e.currentTarget && ("static" === t._config.backdrop ? t._element.focus() : t.hide())
                        }), i && Et.reflow(this._backdrop), de(this._backdrop).addClass(Pe), !e) return;
                    if (!i) return void e();
                ...
                if (this._isBodyOverflowing) {
                    ...
                    de(e).each(function(e, t) {
                        ...
                        de(t).data("padding-right", i).css("padding-right", parseFloat(n) + r._scrollbarWidth + "px")
                    }), de(t).each(function(e, t) {
                        var i = t.style.marginRight,
                            n = de(t).css("margin-right");
                        de(t).data("margin-right", i).css("margin-right", parseFloat(n) - r._scrollbarWidth + "px")
                    });
                    var i = document.body.style.paddingRight,
                        n = de(document.body).css("padding-right");
                    de(document.body).data("padding-right", i).css("padding-right", parseFloat(n) + this._scrollbarWidth + "px")
                }
        ...
        }), de.fn[fe] = Ce._jQueryInterface, de.fn[fe].Constructor = Ce, de.fn[fe].noConflict = function() {
            return de.fn[fe] = ye, Ce._jQueryInterface
        }, Ce),
        Qt = (je = "tooltip", Ye = "." + (ke = "bs.tooltip"), Ie = (Ee = t).fn[je], Ae = "bs-tooltip", Oe = new RegExp("(^|\\s)" + Ae + "\\S+", "g"), ze = {
            animation: !0,
        ...
        }, Fe = "fade", Re = "show", ".tooltip-inner", ".arrow", Be = "hover", Ne = "focus", "click", "manual", We = function() {
            function n(e, t) {
            ...
            return e.enable = function() {
                ...
                if (this._isEnabled)
                    if (e) {
                        ...
                        i || (i = new this.constructor(e.currentTarget, this._getDelegateConfig()), Ee(e.currentTarget).data(t, i)), i._activeTrigger.click = !i._activeTrigger.click, i._isWithActiveTrigger() ? i._enter(null, i) : i._leave(null, i)
                    } else {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    Ee(n).data(this.constructor.DATA_KEY, this), Ee.contains(this.element.ownerDocument.documentElement, this.tip) || Ee(n).appendTo(a), Ee(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new u(this.element, n, {
                        placement: s,
                        modifiers: {
                            offset: {
                    ...
                    }), Ee(n).addClass(Re), "ontouchstart" in document.documentElement && Ee(document.body).children().on("mouseover", null, Ee.noop);
                    var l = function() {
                ...
                var t = this,
                    ...
                    r = function() {
                        t._hoverState !== Le && i.parentNode && i.parentNode.removeChild(i), t._cleanTipClass(), t.element.removeAttribute("aria-describedby"), Ee(t.element).trigger(t.constructor.Event.HIDDEN), null !== t._popper && t._popper.destroy(), e && e()
                    };
                if (Ee(this.element).trigger(n), !n.isDefaultPrevented()) {
                    if (Ee(i).removeClass(Re), "ontouchstart" in document.documentElement && Ee(document.body).children().off("mouseover", null, Ee.noop), this._activeTrigger.click = !1, this._activeTrigger[Ne] = !1, this._activeTrigger[Be] = !1, Ee(this.tip).hasClass(Fe)) {
                ...
                this.config.trigger.split(" ").forEach(function(e) {
                    if ("click" === e) Ee(n.element).on(n.constructor.Event.CLICK, n.config.selector, function(e) {
                        return n.toggle(e)
                    });
                    else if ("manual" !== e) {
                        ...
                        Ee(n.element).on(t, n.config.selector, function(e) {
                            return n._enter(e)
                        }).on(i, n.config.selector, function(e) {
                            return n._leave(e)
                        })
                    }
                    Ee(n.element).closest(".modal").on("hide.bs.modal", function() {
                        return n.hide()
                    })
                ...
                var i = this.constructor.DATA_KEY;
                (t = t || Ee(e.currentTarget).data(i)) || (t = new this.constructor(e.currentTarget, this._getDelegateConfig()), Ee(e.currentTarget).data(i, t)), e && (t._activeTrigger["focusout" === e.type ? Ne : Be] = !1), t._isWithActiveTrigger() || (clearTimeout(t._timeout), t._hoverState = "out", t.config.delay && t.config.delay.hide ? t._timeout = setTimeout(function() {
                ...
                return "number" == typeof(e = l({}, this.constructor.Default, Ee(this.element).data(), "object" == typeof e && e ? e : {})).delay && (e.delay = {
                    show: e.delay,
                    hide: e.delay
                }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), Et.typeCheckConfig(je, e, this.constructor.DefaultType), e
        ...
        }(), Ee.fn[je] = We._jQueryInterface, Ee.fn[je].Constructor = We, Ee.fn[je].noConflict = function() {
            return Ee.fn[je] = Ie, We._jQueryInterface
        }, We),
        Dt = ($e = "popover", Ve = "." + (qe = "bs.popover"), Ue = (He = t).fn[$e], Xe = "bs-popover", Ke = new RegExp("(^|\\s)" + Xe + "\\S+", "g"), Ge = l({}, Qt.Default, {
            placement: "right",
            trigger: "click",
            content: "",
        ...
        }(Qt), He.fn[$e] = et._jQueryInterface, He.fn[$e].Constructor = et, He.fn[$e].noConflict = function() {
            return He.fn[$e] = Ue, et._jQueryInterface
        }, et),
        zt = (it = "scrollspy", rt = "." + (nt = "bs.scrollspy"), ot = (tt = t).fn[it], st = {
            offset: 10,
            method: "auto",
            target: ""
        }, at = {
        ...
        }, "dropdown-item", ct = "active", '[data-spy="scroll"]', ".active", ut = ".nav, .list-group", ht = ".nav-link", ".nav-item", pt = ".list-group-item", ".dropdown", ".dropdown-item", ".dropdown-toggle", "offset", dt = "position", ft = function() {
            function i(e, t) {
                var i = this;
                this._element = e, this._scrollElement = "BODY" === e.tagName ? window : e, this._config = this._getConfig(t), this._selector = this._config.target + " " + ht + "," + this._config.target + " " + pt + "," + this._config.target + " .dropdown-item", this._offsets = [], this._targets = [], this._activeTarget = null, this._scrollHeight = 0, tt(this._scrollElement).on(lt.SCROLL, function(e) {
                    return i._process(e)
            ...
            return e.refresh = function() {
                ...
                tt.removeData(this._element, nt), tt(this._scrollElement).off(rt), this._element = null, this._scrollElement = null, this._config = null, this._selector = null, this._offsets = null, this._targets = null, this._activeTarget = null, this._scrollHeight = null
            }, e._getConfig = function(e) {
                ...
                i.hasClass("dropdown-item") ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(ct), i.addClass(ct)) : (i.addClass(ct), i.parents(ut).prev(ht + ", " + pt).addClass(ct), i.parents(ut).prev(".nav-item").children(ht).addClass(ct)), tt(this._scrollElement).trigger(lt.ACTIVATE, {
                    relatedTarget: t
                })
            }, e._clear = function() {
        ...
        }), tt.fn[it] = ft._jQueryInterface, tt.fn[it].Constructor = ft, tt.fn[it].noConflict = function() {
            return tt.fn[it] = ot, ft._jQueryInterface
        }, ft),
        Lt = (yt = "." + (gt = "bs.tab"), vt = (mt = t).fn.tab, bt = {
            HIDE: "hide" + yt,
            HIDDEN: "hidden" + yt,
            SHOW: "show" + yt,
            SHOWN: "shown" + yt,
            CLICK_DATA_API: "click" + yt + ".data-api"
        }, "dropdown-menu", _t = "active", "disabled", "fade", "show", ".dropdown", ".nav, .list-group", wt = ".active", Tt = "> li > .active", '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', ".dropdown-toggle", "> .dropdown-menu .active", Pt = function() {
            function n(e) {
                this._element = e
            }
            var e = n.prototype;
        ...
        }), mt.fn.tab = Pt._jQueryInterface, mt.fn.tab.Constructor = Pt, mt.fn.tab.noConflict = function() {
    ...
    }(t), e.Util = Et, e.Alert = jt, e.Button = kt, e.Carousel = Yt, e.Collapse = It, e.Dropdown = At, e.Modal = Ot, e.Popover = Dt, e.Scrollspy = zt, e.Tab = Lt, e.Tooltip = Qt, Object.defineProperty(e, "__esModule", {
        value: !0
    })
});
var PageTransitions = function() {
    var e, t, c = $("#main").children(".pt-page"),
        i = $(".nav-menu .pt-link"),
        u = 1,
        h = (c.length, 0),
        p = !1,
    ...
    function n() {
        ...
        }), c.eq(h).addClass("page-active"), 0 < i.length && (window.onhashchange = function() {
            var e = location.hash,
                t = [];
            i.each(function() {
                t.push($(this).attr("href"))
            }), 0 <= t.indexOf(e) && ($nextPageIndex = $(e).index(), 67 < u && (u = 1), i.removeClass("active"), i.eq(t.indexOf(e)).addClass("active"), function(e) {
                var t, i, n = $("html").data("randomAnimation"),
    ...
    return e = [], t = location.hash, i.each(function() {
        e.push($(this).attr("href"))
    }), 0 <= e.indexOf(t) && (h = e.indexOf(t), i.removeClass("active"), i.eq(e.indexOf(t)).addClass("active")), n(), {
        init: n
    }
}();
jQuery(document).ready(function(s) {
        ...
        function f(e) {
            ...
            if (e.parents(".cd-headline").hasClass("type")) {
                ...
                }(e.find("i").eq(0), e, n, r), g(t.find("i").eq(0), t, n, r)
            ...
            }, c)) : (v(e, t), setTimeout(function() {
                f(t)
            }, a))
        }

        function m(e, t) {
            e.parents(".cd-headline").hasClass("type") ? (g(e.find("i").eq(0), e, !1, t), e.addClass("is-visible").removeClass("is-hidden")) : e.parents(".cd-headline").hasClass("clip") && e.parents(".cd-words-wrapper").animate({
                width: e.width() + 10
            }, d, function() {
                setTimeout(function() {
                    f(e)
        ...
        }), e = s(".cd-headline"), o = a, e.each(function() {
            var e = s(this);
            if (e.hasClass("loading-bar")) o = l, setTimeout(function() {
        ...
        c.Defaults = {
            ...
            run: function(e) {
                ...
                for (e.items = {
                        merge: !1,
                        width: t
                    }; n--;) i = this._mergers[n], i = this.settings.mergeFit && Math.min(i, this.settings.items) || i, e.items.merge = 1 < i || e.items.merge, o[n] = r ? t * i : this._items[n].width();
                this._widths = o
            }
        }, {
            filter: ["items", "settings"],
            ...
            l(r).off(".owl.core"), this.$element.removeClass(this.options.grabClass), (0 !== t.x && this.is("dragging") || !this.is("valid")) && (this.speed(this.settings.dragEndSpeed || this.settings.smartSpeed), this.current(this.closest(i.x, 0 !== t.x ? n : this._drag.direction)), this.invalidate("position"), this.update(), this._drag.direction = n, (3 < Math.abs(t.x) || 300 < (new Date).getTime() - this._drag.time) && this._drag.target.one("click.owl.core", function() {
                return !1
            ...
            return this.settings.freeDrag || l.each(s, l.proxy(function(e, t) {
                return "left" === n && t - 30 < i && i < t + 30 ? r = e : "right" === n && t - o - 30 < i && i < t - o + 30 ? r = e + 1 : this.op(i, "<", t) && this.op(i, ">", s[e + 1] !== a ? s[e + 1] : t - o) && (r = "left" === n ? e + 1 : e), -1 === r
            }, this)), this.settings.loop || (this.op(i, ">", s[this.minimum()]) ? r = i = this.minimum() : this.op(i, "<", s[this.maximum()]) && (r = i = this.maximum())), r
            ...
            var i = this.current(),
                ...
                a = this.minimum(),
                l = this.maximum();
            this.settings.loop ? (!this.settings.rewind && Math.abs(r) > s / 2 && (r += -1 * o * s), (n = (((e = i + r) - a) % s + s) % s + a) !== e && n - r <= l && 0 < n - r && (i = n - r, e = n, this.reset(i))) : this.settings.rewind ? e = (e % (l += 1) + l) % l : e = Math.max(a, Math.min(l, e)), this.speed(this.duration(i, e, t)), this.current(e), this.isVisible() && this.update()
            ...
            var e;
            return this.options.responsiveBaseElement !== i ? e = l(this.options.responsiveBaseElement).width() : i.innerWidth ? e = i.innerWidth : r.documentElement && r.documentElement.clientWidth ? e = r.documentElement.clientWidth : console.warn("Can not detect viewport width."), e
            ...
            for (var e in this.$element.off(".owl.core"), this.$stage.off(".owl.core"), l(r).off(".owl.core"), !1 !== this.settings.responsive && (i.clearTimeout(this.resizeTimer), this.off(i, "resize", this._handlers.onThrottledResize)), this._plugins) this._plugins[e].destroy();
            ...
            var o = {
                ...
                s = l.camelCase(l.grep(["on", e, i], function(e) {
                    return e
                }).join("-").toLowerCase()),
    ...
    function(s, i, e, t) {
        ...
        n.Defaults = {
            ...
            s.each(n, function(e, t) {
                r.push(s(t).height())
            }), (o = Math.max.apply(null, r)) <= 1 && i && this._previousHeight && (o = this._previousHeight), this._previousHeight = o, this._core.$stage.parent().height(o).addClass(this._core.settings.autoHeightClass)
    ...
    function(u, e, t, i) {
        ...
        n.Defaults = {
            ...
            var i, n, r = e.width && e.height ? "width:" + e.width + "px;height:" + e.height + "px;" : "",
                o = t.find("img"),
                s = "src",
                a = "",
            ...
            if (t.wrap(u("<div/>", {
                    ...
                    style: r
                })), this._core.settings.lazyLoad && (s = "data-src", a = "owl-lazy"), o.length) return c(o.attr(s)), o.remove(), !1;
            "youtube" === e.type ? (n = "//img.youtube.com/vi/" + e.id + "/hqdefault.jpg", c(n)) : "vimeo" === e.type ? u.ajax({
                type: "GET",
            ...
            var t, i = u(e.target).closest("." + this._core.settings.itemClass),
                n = this._videos[i.attr("data-video")],
                r = n.width || "100%",
                o = n.height || this._core.$stage.height();
            this._playing || (this._core.enter("playing"), this._core.trigger("play", null, "video"), i = this._core.items(this._core.relative(i.index())), this._core.reset(i.index()), (t = u('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr("height", o), t.attr("width", r), "youtube" === n.type ? t.attr("src", "//www.youtube.com/embed/" + n.id + "?autoplay=1&rel=0&v=" + n.id) : "vimeo" === n.type ? t.attr("src", "//player.vimeo.com/video/" + n.id + "?autoplay=1") : "vzaar" === n.type && t.attr("src", "//view.vzaar.com/" + n.id + "/player?autoplay=true"), u(t).wrap('<div class="owl-video-frame" />').insertAfter(i.find(".owl-video")), this._playing = i.addClass("owl-video-playing"))
    ...
    function(s, e, t, i) {
        var n = function(e) {
            this.core = e, this.core.options = s.extend({}, n.Defaults, this.core.options), this.swapping = !0, this.previous = void 0, this.next = void 0, this.handlers = {
        ...
        n.Defaults = {
            ...
            if (1 === this.core.settings.items && s.support.animation && s.support.transition) {
                ...
                this.core.current() !== this.previous && (o && (e = this.core.coordinates(this.previous) - this.core.coordinates(this.next), i.one(s.support.animation.end, t).css({
                    left: e + "px"
                }).addClass("animated owl-animated-out").addClass(o)), r && n.one(s.support.animation.end, t).addClass("animated owl-animated-in").addClass(r))
            }
    ...
    function(o, e, t, i) {
        ...
        n.Defaults = {
            ...
            for (e in this._controls.$relative = (i.navContainer ? o(i.navContainer) : o("<div>").addClass(i.navContainerClass).appendTo(this.$element)).addClass("disabled"), this._controls.$previous = o("<" + i.navElement + ">").addClass(i.navClass[0]).html(i.navText[0]).prependTo(this._controls.$relative).on("click", o.proxy(function(e) {
                    this.prev(i.navSpeed)
                }, this)), this._controls.$next = o("<" + i.navElement + ">").addClass(i.navClass[1]).html(i.navText[1]).appendTo(this._controls.$relative).on("click", o.proxy(function(e) {
                    this.next(i.navSpeed)
                }, this)), i.dotsData || (this._templates = [o('<button role="button">').addClass(i.dotClass).append(o("<span>")).prop("outerHTML")]), this._controls.$absolute = (i.dotsContainer ? o(i.dotsContainer) : o("<div>").addClass(i.dotsClass).appendTo(this.$element)).addClass("disabled"), this._controls.$absolute.on("click", "button", o.proxy(function(e) {
            ...
            var e, t = this._core.settings,
                ...
                r = t.loop || t.rewind;
            this._controls.$relative.toggleClass("disabled", !t.nav || i), t.nav && (this._controls.$previous.toggleClass("disabled", !r && n <= this._core.minimum(!0)), this._controls.$next.toggleClass("disabled", !r && n >= this._core.maximum(!0))), this._controls.$absolute.toggleClass("disabled", !t.dots || i), t.dots && (e = this._pages.length - this._controls.$absolute.children().length, t.dotsData && 0 !== e ? this._controls.$absolute.html(this._templates.join("")) : 0 < e ? this._controls.$absolute.append(new Array(e + 1).join(this._templates[0])) : e < 0 && this._controls.$absolute.children().slice(e).remove(), this._controls.$absolute.find(".active").removeClass("active"), this._controls.$absolute.children().eq(o.inArray(this.current(), this._pages)).addClass("active"))
            ...
            return "page" == n.slideBy ? (t = o.inArray(this.current(), this._pages), i = this._pages.length, e ? ++t : --t, t = this._pages[(t % i + i) % i].start) : (t = this._core.relative(this._core.current()), i = this._core.items().length, e ? t += n.slideBy : t -= n.slideBy), t
    ...
    function(n, r, e, t) {
        ...
        var i = function(e) {
            ...
            }, this._core.options = n.extend({}, i.Defaults, this._core.options), this.$element.on(this._handlers), n(r).on("hashchange.owl.navigation", n.proxy(function(e) {
    ...
    function(r, e, t, o) {
        ...
        (function() {
            return !!i("transition")
        })() && (r.support.transition = new String(n("transition")), r.support.transition.end = l.transition.end[r.support.transition]), h() && (r.support.animation = new String(n("animation")), r.support.animation.end = l.animation.end[r.support.animation]), c() && (r.support.transform = new String(n("transform")), r.support.transform3d = u())
    }(window.Zepto || window.jQuery, window, document),
    function(e, t) {
        ...
        t.default = function(i) {
            ...
            if (i) {
                var r = {
                    ...
                    o = [],
                    t = null,
                    s = "requestAnimationFrame" in i ? function() {
                        i.cancelAnimationFrame(t), t = i.requestAnimationFrame(function() {
                    ...
                    l = function(e) {
                        e.filter(function(e) {
                            ...
                            e.styleComputed = h(e)
                        }), e.filter(p).forEach(f), e.filter(u).forEach(c), e.forEach(d), e.forEach(m)
                    },
                    c = function(e) {
                ...
                }), e.observeWindow = !0, e.observeWindowDelay = 100, e.fitAll = a(r.DIRTY), e
            }
    ...
    function(e) {
        ...
        function i(c) {
            if (c) {
                var u = "undefined" == typeof console ? t : function(e) {
                    console.error(e)
                };
    ...
    function(i) {
        ...
        var r = function() {};
        e.removeEventListener ? r = function(e, t, i) {
            e.removeEventListener(t, i, !1)
        } : e.detachEvent && (r = function(t, i, n) {
    ...
    function() {
        ...
        i.getListeners = function(e) {
            ...
            var i, n = this.getListenersAsObject(e),
                r = "object" == typeof t;
            for (i in n) n.hasOwnProperty(i) && -1 === o(n[i], t) && n[i].push(r ? t : {
                listener: t,
                once: !1
            });
            return this
            ...
            var i, n, r, o = this.getListenersAsObject(e);
            for (r in o)
                if (o.hasOwnProperty(r))
                    for (n = o[r].length; n--;) !0 === (i = o[r][n]).once && this.removeListener(e, i.listener), i.listener.apply(this, t || []) === this._getOnceReturnValue() && this.removeListener(e, i.listener);
            return this
    ...
    function(r) {
        ...
        if (n) {
            ...
            o(e);
            for (var i = e.parentNode.querySelectorAll(t), n = 0, r = i.length; n < r; n++)
                if (i[n] === e) return !0;
            return !1
        };
    ...
    function(i, n) {
        ...
        d.isArray = function(e) {
            ...
            var i = d.indexOf(e, t); - 1 != i && e.splice(i, 1)
        ...
        var f = p.console;
        return d.htmlInit = function(u, h) {
            e(function() {
    ...
    function(r, o) {
        "use strict";
        "function" == typeof define && define.amd ? define("outlayer/item", ["eventEmitter/EventEmitter", "get-size/get-size", "get-style-property/get-style-property", "fizzy-ui-utils/utils"], function(e, t, i, n) {
            return o(r, e, t, i, n)
        ...
        }, r.prototype.transition = r.prototype[a ? "_transition" : "_nonTransition"], r.prototype.onwebkitTransitionEnd = function(e) {
    ...
    function(o, s) {
        "use strict";
        "function" == typeof define && define.amd ? define("outlayer/outlayer", ["eventie/eventie", "eventEmitter/EventEmitter", "get-size/get-size", "fizzy-ui-utils/utils", "./item"], function(e, t, i, n, r) {
        ...
        var a = e.console,
            ...
            u = 0,
            h = {};
        return o.namespace = "outlayer", o.Item = n, o.defaults = {
            containerStyle: {
                position: "relative"
            },
            isInitLayout: !0,
        ...
        }, s.extend(o.prototype, i.prototype), o.prototype.option = function(e) {
        ...
        }, o.prototype._getContainerSize = c, o.prototype._setContainerMeasure = function(e, t) {
            if (void 0 !== e) {
                var i = this.size;
        ...
        }, o.prototype._manageStamp = c, o.prototype._getElementOffset = function(e) {
            ...
            return Object.create ? i.prototype = Object.create(o.prototype) : s.extend(i.prototype, o.prototype), (i.prototype.constructor = i).defaults = s.extend({}, o.defaults), s.extend(i.defaults, t), i.prototype.settings = {}, i.namespace = e, i.data = o.data, (i.Item = function() {
                n.apply(this, arguments)
            }).prototype = new n, s.htmlInit(i, e), l && l.bridget && l.bridget(e, i), i
        }, o.Item = n, o
    }),
    function(e, t) {
        "use strict";
    ...
    function(e, t) {
        ...
        return t.prototype._resetLayout = function() {
            ...
            for (var n = this._getColGroup(i), r = Math.min.apply(Math, n), o = u.indexOf(n, r), s = {
                    x: this.columnWidth * o,
                    y: r
                }, a = r + e.size.outerHeight, l = this.cols + 1 - n.length, c = 0; c < l; c++) this.colYs[o + c] = a;
            return s
    ...
    function(e, t) {
        ...
        (function(e, t) {
            for (var i in t) e[i] = t[i]
        })(i.prototype, t.prototype), i.prototype._getElementOffset = n, i.prototype.layout = r, i.prototype._getMeasurement = o;
    ...
    function(s, a) {
        "use strict";
        "function" == typeof define && define.amd ? define(["outlayer/outlayer", "get-size/get-size", "matches-selector/matches-selector", "fizzy-ui-utils/utils", "isotope/js/item", "isotope/js/layout-mode", "isotope/js/layout-modes/masonry", "isotope/js/layout-modes/fit-rows", "isotope/js/layout-modes/vertical"], function(e, t, i, n, r, o) {
        ...
        var a = e.jQuery,
            ...
            u = document.documentElement.textContent ? function(e) {
    ...
    function(e) {
        ...
        e.prototype = {
            ...
            init: function() {
                ...
                h.isIE7 = -1 !== e.indexOf("MSIE 7."), h.isIE8 = -1 !== e.indexOf("MSIE 8."), h.isLowIE = h.isIE7 || h.isIE8, h.isAndroid = /android/gi.test(e), h.isIOS = /iphone|ipad|ipod/gi.test(e), h.supportsTransition = function() {
                    ...
                    return !1
                }(), h.probablyMobile = h.isAndroid || h.isIOS || /(Opera Mini)|Kindle|webOS|BlackBerry|(Opera Mobi)|(Windows Phone)|IEMobile/i.test(navigator.userAgent), p = u(document), h.popupsCache = {}
            },
            open: function(e) {
                var t;
                if (!1 === e.isObj) {
                ...
                if (!h.isOpen) {
                    h.types = [], d = "", e.mainEl && e.mainEl.length ? h.ev = e.mainEl.eq(0) : h.ev = p, e.key ? (h.popupsCache[e.key] || (h.popupsCache[e.key] = {}), h.currTemplate = h.popupsCache[e.key]) : h.currTemplate = {}, h.st = u.extend(!0, {}, u.magnificPopup.defaults, e), h.fixedContentPos = "auto" === h.st.fixedContentPos ? !h.probablyMobile : h.st.fixedContentPos, h.st.modal && (h.st.closeOnContentClick = !1, h.st.closeOnBgClick = !1, h.st.showCloseBtn = !1, h.st.enableEscapeKey = !1), h.bgOverlay || (h.bgOverlay = _("bg").on("click" + g, function() {
                        h.close()
                    }), h.wrap = _("wrap").attr("tabindex", -1).on("click" + g, function(e) {
                    ...
                    w("BeforeOpen"), h.st.showCloseBtn && (h.st.closeBtnInside ? (b(f, function(e, t, i, n) {
                        i.close_replaceWith = T(n.type)
                    }), d += " mfp-close-btn-in") : h.wrap.append(T())), h.st.alignTop && (d += " mfp-align-top"), h.fixedContentPos ? h.wrap.css({
                        ...
                        height: p.height(),
                        position: "absolute"
                    }), h.st.enableEscapeKey && p.on("keyup" + g, function(e) {
                        27 === e.keyCode && h.close()
                    }), v.on("resize" + g, function() {
                        h.updateSize()
                    }), h.st.closeOnContentClick || (d += " mfp-auto-cursor"), d && h.wrap.addClass(d);
                    var s = h.wH = v.height(),
                        a = {};
                    ...
                    return h.isIE7 && (c += " mfp-ie7"), c && h._addClassToMFP(c), h.updateItemHTML(), w("BuildControls"), u("html").css(a), h.bgOverlay.add(h.wrap).prependTo(h.st.prependTo || u(document.body)), h._lastFocusedEl = document.activeElement, setTimeout(function() {
                        h.content ? (h._addClassToMFP(y), h._setFocus()) : h.bgOverlay.addClass(y), p.on("focusin" + g, h._onFocusIn)
                    }, 16), h.isOpen = !0, h.updateSize(s), w(m), e
                }
                h.updateItemHTML()
            },
            close: function() {
                h.isOpen && (w(c), h.isOpen = !1, h.st.removalDelay && !h.isLowIE && h.supportsTransition ? (h._addClassToMFP(i), setTimeout(function() {
                    h._close()
            ...
            appendContent: function(e, t) {
                (h.content = e) ? h.st.showCloseBtn && h.st.closeBtnInside && !0 === h.currTemplate[t] ? h.content.find(".mfp-close").length || h.content.append(T()) : h.content = e: h.content = "", w("BeforeAppend"), h.container.addClass("mfp-" + t + "-holder"), h.contentContainer.append(h.content)
            },
            parseEl: function(e) {
                var t, i = h.items[e];
                if (i.tagName ? i = {
            ...
            _parseMarkup: function(r, e, t) {
                var o;
                t.data && (e = u.extend(t.data, e)), w(f, [r, e, t]), u.each(e, function(e, t) {
            ...
            if ("string" == typeof e)
                if ("open" === e) {
                    ...
                    n.items ? i = n.items[r] : (i = t, n.delegate && (i = i.find(n.delegate)), i = i.eq(r)), h._openClick({
                        mfpEl: i
                    }, t, n)
                ...
                getAjax: function(r) {
                    ...
                    var e = u.extend({
                        ...
                        success: function(e, t, i) {
                            ...
                            w("ParseAjax", n), h.appendContent(u(n.data), k), r.finished = !0, Y(), h._setFocus(), setTimeout(function() {
                                h.wrap.addClass(y)
        ...
        u.magnificPopup.registerModule("image", {
            ...
            proto: {
                ...
                getImage: function(e, t) {
                    var i = 0,
                        n = function() {
                            e && (e.img[0].complete ? (e.img.off(".mfploader"), e === h.currItem && (h._onImageHasSize(e), h.updateStatus("ready")), e.hasSize = !0, e.loaded = !0, w("ImageLoadComplete")) : ++i < 200 ? setTimeout(n, 100) : r())
                        },
                        r = function() {
                    ...
                    if (s.length) {
                        ...
                        a.className = "mfp-img", e.el && e.el.find("img").length && (a.alt = e.el.find("img").attr("alt")), e.img = u(a).on("load.mfploader", n).on("error.mfploader", r), a.src = e.src, s.is("img") && (e.img = e.img.clone()), 0 < (a = e.img[0]).naturalWidth ? e.hasSize = !0 : a.width || (e.hasSize = !1)
                    }
                    ...
                    }, e), h.resizeImage(), e.hasSize ? (A && clearInterval(A), e.loadError ? (t.addClass("mfp-loading"), h.updateStatus("error", o.tError.replace("%url%", e.src))) : (t.removeClass("mfp-loading"), h.updateStatus("ready"))) : (h.updateStatus("loading"), e.loading = !0, e.hasSize || (e.imgHidden = !0, t.addClass("mfp-loading"), h.findImageSize(e))), t
                }
            }
        });
        var O;
                    ...
                    if (o.enabled && h.supportsTransition) {
                        ...
                        b("BuildControls" + t, function() {
                            if (h._allowZoom()) {
                                ...
                                (n = s(e)).css(h._getOffset()), h.wrap.append(n), i = setTimeout(function() {
        ...
        u.magnificPopup.registerModule(Q, {
            ...
            proto: {
                initIframe: function() {
                    h.types.push(Q), b("BeforeChange", function(e, t, i) {
                        t !== i && (t === Q ? D() : i === Q && D(!0))
                    }), b(l + "." + Q, function() {
                        D()
                    })
        ...
        u.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function() {
                    ...
                    return h.direction = !0, !(!o || !o.enabled) && (d += " mfp-gallery", b(m + e, function() {
                        ...
                        if (1 < h.items.length && o.arrows && !h.arrowLeft) {
                            ...
                            t[n](function() {
                                ...
                                h.next()
                            }), h.isIE7 && (_("b", t[0], !1, !0), _("a", t[0], !1, !0), _("b", i[0], !1, !0), _("a", i[0], !1, !0)), h.container.append(t.add(i))
                        }
                    }), b("Change" + e, function() {
                ...
                _preloadItem: function(e) {
                    if (e = z(e), !h.items[e].preloaded) {
                        var t = h.items[e];
                        t.parsed || (t = h.parseEl(e)), w("LazyLoad", t), "image" === t.type && (t.img = u('<img class="mfp-img" />').on("load.mfploader", function() {
                            t.hasSize = !0
            ...
            proto: {
                initRetina: function() {
                    if (1 < window.devicePixelRatio) {
                        var i = h.st.retina,
                            n = i.ratio;
                        1 < (n = isNaN(n) ? n() : n) && (b("ImageHasSize." + B, function(e, t) {
                            t.img.css({
        ...
        }), M = "ontouchstart" in window, F = function() {
            v.off("touchmove" + R + " touchend" + R)
        }, R = ".mfpFastClick", u.fn.mfpFastClick = function(l) {
            return u(this).each(function() {
                var t, i, n, r, o, s, a, e = u(this);
                M && e.on("touchstart" + R, function(e) {
                    o = !1, a = 1, s = e.originalEvent ? e.originalEvent.touches[0] : e.touches[0], n = s.clientX, r = s.clientY, v.on("touchmove" + R, function(e) {
                        ...
                        F(), o || 1 < a || (t = !0, e.preventDefault(), clearTimeout(i), i = setTimeout(function() {
                            t = !1
                        }, 1e3), l())
                    })
    ...
    function(e, t) {
        ...
        var m = i(function(e) {
            ...
            h = {
                f: e ? Object.defineProperty : function(e, t, i) {
            ...
            S = function(t, e, i) {
                ...
                }) && (x(String.prototype, t, o), P(RegExp.prototype, n, 2 == e ? function(e, t) {
        ...
        var I = function(e) {
            ...
            R = function(e, t, i) {
                var n, r, o, s, a = e & R.F,
                    ...
                    d = l ? v : v[t] || (v[t] = {}),
                    f = d[F] || (d[F] = {});
                for (n in l && (i = t), i) o = ((r = !a && p && void 0 !== p[n]) ? p : i)[n], s = h && r ? M(o, m) : u && "function" == typeof o ? M(Function.call, o) : o, p && x(p, n, o, e & R.U), d[n] != o && P(d, n, s), u && f[n] != o && (f[n] = o)
            };
        ...
        var B, N = R,
            ...
            he = w("toStringTag"),
            pe = function(e, t, i) {
                e && !d(e = i ? e : e.prototype, he) && ue(e, he, {
                    configurable: !0,
                    value: t
                })
            },
        ...
        var fe = function(e) {
            ...
            me = G("IE_PROTO"),
            ge = Object.prototype,
            ye = Object.getPrototypeOf || function(e) {
            ...
            Te = function(e, t, i, n, r, o, s) {
                var a, l, c;
                l = t, c = n, (a = i).prototype = ce(de, {
                    next: T(1, c)
                }), pe(a, l + " Iterator");
                var u, h, p, d = function(e) {
                ...
                if (w && (p = ye(w.call(new e))) !== Object.prototype && p.next && (pe(p, f, !0), "function" != typeof p[ve] && P(p, ve, we)), m && v && v.name !== _e && (g = !0, b = function() {
                        return v.call(this)
                    }), (be || g || !y[ve]) && P(y, ve, b), O[t] = b, O[f] = we, r)
                    if (u = {
                            values: m ? b : d(_e),
                            keys: o ? b : d("keys"),
                            entries: _
        ...
        for (var Pe = w("iterator"), xe = w("toStringTag"), Se = O.Array, Ce = {
                CSSRuleList: !0,
                ...
                TextTrackList: !1,
                TouchList: !1
            }, Ee = te(Ce), je = 0; je < Ee.length; je++) {
            var ke, Ye = Ee[je],
                Ie = Ce[Ye],
                Ae = m[Ye],
                Oe = Ae && Ae.prototype;
            if (Oe && (Oe[Pe] || P(Oe, Pe, Se), Oe[xe] || P(Oe, xe, Ye), O[Ye] = Se, Ie))
        ...
        var Qe = function(t, e, i, n) {
            ...
            Me = w("toStringTag"),
            Fe = "Arguments" == D(function() {
                return arguments
            }()),
            Re = w("iterator"),
            Be = v.getIteratorMethod = function(e) {
                if (null != e) return e[Re] || e["@@iterator"] || O[(t = e, void 0 === t ? "Undefined" : null === t ? "Null" : "string" == typeof(n = function(e, t) {
                    try {
                        return e[t]
                    } catch (e) {}
                }(i = Object(t), Me)) ? n : Fe ? D(i) : "Object" == (r = D(i)) && "function" == typeof i.callee ? "Arguments" : r)];
                var t, i, n, r
            },
            Ne = w("iterator"),
            We = !1;
        ...
        N(N.S + N.F * ! function(e, t) {
            ...
            from: function(e) {
                ...
                if (u && (c = M(c, 2 < l ? arguments[2] : void 0, 2)), null != p && (a != Array || (void 0 === (o = p) || O.Array !== o && ze[De] !== o)))
                    ...
                    for (i = new a(t = V(s.length)); h < t; h++) Le(i, h, u ? c(s[h], h) : s[h]);
                return i.length = h, i
            }
        });
        var He = {
        ...
        function ht(n, r, e) {
            ...
            return r = dt(r) || 0, pt(e) && (p = !!e.leading, a = (d = "maxWait" in e) ? lt(dt(e.maxWait) || 0, r) : a, t = "trailing" in e ? !!e.trailing : t), i.cancel = function() {
        ...
        var ft = function(e, t, i) {
                ...
                return pt(i) && (n = "leading" in i ? !!i.leading : n, r = "trailing" in i ? !!i.trailing : r), ht(e, t, {
                    leading: n,
                    maxWait: t,
                    trailing: r
                })
            ...
            vt = "function" == typeof requestAnimationFrame ? requestAnimationFrame.bind(yt) : function(e) {
        ...
        wt.prototype.addObserver = function(e) {
            ...
            gt && !this.connected_ && (document.addEventListener("transitionend", this.onTransitionEnd_), window.addEventListener("resize", this.refresh), _t ? (this.mutationsObserver_ = new MutationObserver(this.refresh), this.mutationsObserver_.observe(document, {
                attributes: !0,
                childList: !0,
                characterData: !0,
                subtree: !0
        ...
        function Et(e) {
            var t = e.clientWidth,
                i = e.clientHeight;
            if (!t && !i) return xt;
            var n, r = Pt(e).getComputedStyle(e),
                o = function(e) {
        ...
        var jt = "undefined" != typeof SVGGraphicsElement ? function(e) {
        ...
        var At = function(e, t) {
                var i, n, r, o, s, a, l, c = (n = (i = t).x, r = i.y, o = i.width, s = i.height, a = "undefined" != typeof DOMRectReadOnly ? DOMRectReadOnly : Object, l = Object.create(a.prototype), Tt(l, {
                    x: n,
                    y: r,
                    width: o,
                    height: s,
        ...
        var zt = void 0 !== yt.ResizeObserver ? yt.ResizeObserver : Dt,
            ...
            Mt = function() {
                function i(e, t) {
                    ...
                    ! function(e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, i), this.onScrollX = function() {
                ...
                return e = i, n = [{
                    ...
                    value: function() {
                        ...
                        if (!this.trackX || !this.trackY) {
                            var e = document.createElement("div"),
                                i = document.createElement("div");
                            e.classList.add(this.classNames.track), i.classList.add(this.classNames.scrollbar), this.options.autoHide || i.classList.add("visible"), e.appendChild(i), this.trackX = e.cloneNode(!0), this.trackX.classList.add("horizontal"), this.trackY = e.cloneNode(!0), this.trackY.classList.add("vertical"), this.el.insertBefore(this.trackX, this.el.firstChild), this.el.insertBefore(this.trackY, this.el.firstChild)
                        }
                    ...
                    value: function() {
                        ...
                        this.options.autoHide && this.el.addEventListener("mouseenter", this.onMouseEnter), this.el.addEventListener("mousedown", this.onMouseDown), this.contentEl.addEventListener("scroll", this.onScrollX), this.scrollContentEl.addEventListener("scroll", this.onScrollY), window.addEventListener("resize", this.onWindowResize), "undefined" != typeof MutationObserver && (this.mutationObserver = new MutationObserver(function(e) {
                            ...
                            characterData: !0,
                            subtree: !0
                        })), this.resizeObserver = new zt(this.recalculate), this.resizeObserver.observe(this.el)
                    }
                }, {
                    key: "recalculate",
                    value: function() {
                    ...
                    key: "resizeScrollbar",
                    value: function() {
                        var e, t, i, n = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "y";
                        if (this.isEnabled[n] || this.options.forceVisible) {
                            ...
                            var r = i / t;
                            this.handleSize = Math.max(~~(r * i), this.options.scrollbarMinSize), this.options.scrollbarMaxSize && (this.handleSize = Math.min(this.handleSize, this.options.scrollbarMaxSize)), "x" === n ? e.style.width = "".concat(this.handleSize, "px") : e.style.height = "".concat(this.handleSize, "px")
                        }
                    }
                }, {
                    key: "positionScrollbar",
                    value: function() {
                        var e, t, i, n, r = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "y";
                        "x" === r ? (e = this.scrollbarX, t = this.contentEl[this.scrollOffsetAttr[r]], i = this.contentSizeX, n = this.trackXSize) : (e = this.scrollbarY, t = this.scrollContentEl[this.scrollOffsetAttr[r]], i = this.contentSizeY, n = this.trackYSize);
                        var o = t / (i - n),
                    ...
                    value: function() {
                        ...
                        this.isEnabled[e] || this.options.forceVisible ? t.style.visibility = "visible" : t.style.visibility = "hidden", this.options.forceVisible && (this.isEnabled[e] ? i.style.visibility = "visible" : i.style.visibility = "hidden")
                    }
                }, {
                    key: "hideNativeScrollbar",
                    value: function() {
                        this.scrollbarWidth = Xe(), this.scrollContentEl.style[this.isRtl ? "paddingLeft" : "paddingRight"] = "".concat(this.scrollbarWidth || this.offsetSize, "px"), this.scrollContentEl.style.marginBottom = "-".concat(2 * this.scrollbarWidth || this.offsetSize, "px"), this.contentEl.style.paddingBottom = "".concat(this.scrollbarWidth || this.offsetSize, "px"), 0 !== this.scrollbarWidth && (this.contentEl.style[this.isRtl ? "marginLeft" : "marginRight"] = "-".concat(this.scrollbarWidth, "px"))
                    }
                }, {
                    key: "showScrollbar",
                    value: function() {
                        var e, t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : "y";
                        this.isVisible[t] || (e = "x" === t ? this.scrollbarX : this.scrollbarY, this.isEnabled[t] && (e.classList.add("visible"), this.isVisible[t] = !0), this.options.autoHide && (this.flashTimeout = window.setTimeout(this.hideScrollbars, this.options.timeout)))
                    }
                }, {
                    key: "onDrag",
                    value: function(e) {
...
function isInArray(e, t) {
    ...
    return u.fn.tilt = function(t) {
        ...
        return u.fn.tilt.destroy = function() {
            ...
            u(this).each(function() {
                var e = this;
                this.mousePositions = o.call(this), this.settings = u(this).data("settings"), a.call(this), setTimeout(function() {
                    e.reset = !1
            ...
            this.settings = u.extend({
                ...
                u(e).data("settings", e.settings), e.settings.glare && function() {
                        var e = this.settings.glarePrerender;
                        e || u(this).append('<div class="js-tilt-glare"><div class="js-tilt-glare-inner"></div></div>'), this.glareElementWrapper = u(this).find(".js-tilt-glare"), this.glareElement = u(this).find(".js-tilt-glare-inner"), e || (this.glareElementWrapper.css({
                            position: "absolute",
                            top: "0",
                            left: "0",
                            width: "100%",
...
function(e, t) {
    ...
    function r(e) {
        var t, i, n, r, o, s, a, l = {};
        for (a = 0, s = (o = e.replace(/\s*:\s*/g, ":").replace(/\s*,\s*/g, ",").split(",")).length; a < s && (-1 === (i = o[a]).search(/^(http|https|ftp):\/\//) && -1 !== i.search(":")); a++) t = i.indexOf(":"), n = i.substring(0, t), (r = i.substring(t + 1)) || (r = void 0), "string" == typeof r && (r = "true" === r || "false" !== r && r), "string" == typeof r && (r = isNaN(r) ? r : +r), l[n] = r;
    ...
    function n(e, t, i) {
        if (this.$element = d(e), "string" == typeof t && (t = r(t)), i ? "string" == typeof i && (i = r(i)) : i = {}, "string" == typeof t) t = t.replace(/\.\w*$/, "");
            ...
            for (var n in t) t.hasOwnProperty(n) && (t[n] = t[n].replace(/\.\w*$/, ""));
    ...
    n.prototype.init = function() {
        var e, t, i, n, r, o = this,
            ...
            u = o.settings,
            h = function(e) {
                var t, i, n, r = (e = "" + e).split(/\s+/),
                    o = "50%",
                    s = "50%";
                for (n = 0, t = r.length; n < t; n++) "left" === (i = r[n]) ? o = "0%" : "right" === i ? o = "100%" : "top" === i ? s = "0%" : "bottom" === i ? s = "100%" : "center" === i ? 0 === n ? o = "50%" : s = "50%" : 0 === n ? o = i : s = i;
                return {
                    x: o,
                    y: s
                }
            ...
            p = u.posterType;
        t = o.$wrapper = d("<div>").addClass(u.className).css({
            position: "absolute",
            "z-index": -1,
            top: 0,
            left: 0,
        ...
        }), "object" == typeof s && (s.poster ? a = s.poster : s.mp4 ? a = s.mp4 : s.webm ? a = s.webm : s.ogv && (a = s.ogv)), "detect" === p ? (n = function(e) {
            t.css("background-image", "url(" + e + ")")
        }, r = function() {
            n(this.src)
        }, d('<img src="' + (i = a) + '.gif">').on("load", r), d('<img src="' + i + '.jpg">').on("load", r), d('<img src="' + i + '.jpeg">').on("load", r), d('<img src="' + i + '.png">').on("load", r)) : "none" !== p && t.css("background-image", "url(" + a + "." + p + ")"), "static" === c.css("position") && c.css("position", "relative"), c.prepend(t), "object" == typeof s ? (s.mp4 && (l += '<source src="' + s.mp4 + '.mp4" type="video/mp4">'), s.webm && (l += '<source src="' + s.webm + '.webm" type="video/webm">'), s.ogv && (l += '<source src="' + s.ogv + '.ogv" type="video/ogg">'), e = o.$video = d("<video>" + l + "</video>")) : e = o.$video = d('<video><source src="' + s + '.mp4" type="video/mp4"><source src="' + s + '.webm" type="video/webm"><source src="' + s + '.ogv" type="video/ogg"></video>');
        try {
            e.prop({
                autoplay: u.autoplay,
                loop: u.loop,
        ...
        e.on("resize.vide", function() {
            ...
            return !1
        }), d(document).find("[data-vide-bg]").each(function(e, t) {
            var i = d(t),
    ...
    (s = function(e, t) {
            ...
            s = {
                slide: function(e, t) {
                    ...
                    i.eq(e.upcoming_slide).css({
                        ...
                        1 < r.size() && (r.$control.css({
                            left: -r.width
                        }), i.eq(e.upcoming_slide).css({
                            left: r.width,
                            zIndex: 2
                        }), 0 <= e.outgoing_slide && i.eq(e.outgoing_slide).css({
                            left: r.width,
                            display: "none",
                            zIndex: 0
                        })), t()
                ...
                fade: function(e, t) {
                    ...
                    o.css({
                        ...
                        opacity: 1
                    }, i.options.animation_speed, i.options.animation_easing), 0 <= e.outgoing_slide ? r.animate({
                        opacity: 0
                    }, i.options.animation_speed, i.options.animation_easing, function() {
                        1 < i.size() && (n.eq(e.upcoming_slide).css({
                            zIndex: 2
                        }), 0 <= e.outgoing_slide && n.eq(e.outgoing_slide).css({
                            opacity: 1,
                            display: "none",
                            zIndex: 0
                        })), t()
        ...
        var a = {
                _centerY: function(e) {
                    var t = u(e);
                    t.css({
                        top: (r.height - t.height()) / 2
                    })
                },
                _centerX: function(e) {
                    var t = u(e);
                    t.css({
                        left: (r.width - t.width()) / 2
                    })
                },
                _center: function(e) {
            ...
            l = {
                ...
                _events: function() {
                    r.$el.on("click", r.options.elements.pagination + " a", function(e) {
                        e.preventDefault();
                        var t, i = r._parseHash(this.hash);
                        (t = r._upcomingSlide(i, !0)) !== r.current && r.animate(t, function() {
                            r.start()
                        })
                    })
                }
            };
        return this.css = o, this.image = a, this.pagination = l, this.fx = s, this.animation = this.fx[this.options.animation], this.$control = this.$container.wrap(i).parent(".slides-control"), r._findPositions(), r.width = r._findWidth(), r.height = r._findHeight(), this.css.children(), this.css.containers(), this.css.images(), this.pagination._setup(), n = r._findMultiplier(), r.$el.on("click", r.options.elements.nav + " a", function(e) {
            e.preventDefault(), r.stop(), u(this).hasClass("next") ? r.animate("next", function() {
                r.start()
        ...
        }), r.options.hashchange && u(c).on("hashchange", function() {
        ...
        start: function() {
            var e = this;
            e.options.hashchange ? u(c).trigger("hashchange") : this.animate(), this.options.play && (this.play_id && this.stop(), this.play_id = setInterval(function() {
                e.animate()
        ...
        animate: function(e, t) {
            ...
            if (!(this.animating || (this.animating = !0, void 0 === e && (e = "next"), n.upcoming_slide = this._upcomingSlide(e), n.upcoming_slide >= this.size()))) {
                if (n.outgoing_slide = this.current, n.upcoming_position = 2 * this.width, n.offset = -n.upcoming_position, ("prev" === e || n.outgoing_slide > e) && (n.upcoming_position = 0, n.offset = 0), 1 < i.size() && i.pagination._setCurrent(n.upcoming_slide), i.options.hashchange) {
                    var r = n.upcoming_slide + 1,
                        o = i.$container.children(":eq(" + n.upcoming_slide + ")").attr("id");
                    c.location.hash = o || r
                }
                i.$el.trigger("animating.slides", [n]), i.animation(n, function() {
...
var pJS = function(e, t) {
    ...
    t && Object.deepExtend(d, t), d.tmp.obj = {
        ...
        if (this.radius = (d.particles.size.random ? Math.random() : 1) * d.particles.size.value, d.particles.size.anim.enable && (this.size_status = !1, this.vs = d.particles.size.anim.speed / 100, d.particles.size.anim.sync || (this.vs = this.vs * Math.random())), this.x = i ? i.x : Math.random() * d.canvas.w, this.y = i ? i.y : Math.random() * d.canvas.h, this.x > d.canvas.w - 2 * this.radius ? this.x = this.x - this.radius : this.x < 2 * this.radius && (this.x = this.x + this.radius), this.y > d.canvas.h - 2 * this.radius ? this.y = this.y - this.radius : this.y < 2 * this.radius && (this.y = this.y + this.radius), d.particles.move.bounce && d.fn.vendors.checkOverlap(this, i), this.color = {}, "object" == typeof e.value)
        ...
        d.particles.move.straight ? (this.vx = r.x, this.vy = r.y, d.particles.move.random && (this.vx = this.vx * Math.random(), this.vy = this.vy * Math.random())) : (this.vx = r.x + Math.random() - .5, this.vy = r.y + Math.random() - .5), this.vx_i = this.vx, this.vy_i = this.vy;
        ...
        switch (d.canvas.ctx.fillStyle = n, d.canvas.ctx.beginPath(), e.shape) {
            ...
            case "triangle":
                ...
                break;
            case "polygon":
                d.fn.vendors.drawShape(d.canvas.ctx, e.x - t / (d.particles.shape.polygon.nb_sides / 3.5), e.y - t / .76, 2.66 * t / (d.particles.shape.polygon.nb_sides / 3), d.particles.shape.polygon.nb_sides, 1);
                break;
            case "star":
        ...
        for (var e = 0; e < d.particles.array.length; e++) {
            ...
            if (d.particles.opacity.anim.enable && (1 == t.opacity_status ? (t.opacity >= d.particles.opacity.value && (t.opacity_status = !1), t.opacity += t.vo) : (t.opacity <= d.particles.opacity.anim.opacity_min && (t.opacity_status = !0), t.opacity -= t.vo), t.opacity < 0 && (t.opacity = 0)), d.particles.size.anim.enable && (1 == t.size_status ? (t.radius >= d.particles.size.value && (t.size_status = !1), t.radius += t.vs) : (t.radius <= d.particles.size.anim.size_min && (t.size_status = !0), t.radius -= t.vs), t.radius < 0 && (t.radius = 0)), "bounce" == d.particles.move.out_mode) var n = {
                x_left: t.radius,
                x_right: d.canvas.w,
                y_top: t.radius,
                y_bottom: d.canvas.h
            ...
            switch (t.x - t.radius > d.canvas.w ? (t.x = n.x_left, t.y = Math.random() * d.canvas.h) : t.x + t.radius < 0 && (t.x = n.x_right, t.y = Math.random() * d.canvas.h), t.y - t.radius > d.canvas.h ? (t.y = n.y_top, t.x = Math.random() * d.canvas.w) : t.y + t.radius < 0 && (t.y = n.y_bottom, t.x = Math.random() * d.canvas.w), d.particles.move.out_mode) {
                case "bounce":
        ...
        if (r <= d.particles.line_linked.distance) {
            ...
            if (0 < o) {
                ...
                d.canvas.ctx.strokeStyle = "rgba(" + s.r + "," + s.g + "," + s.b + "," + o + ")", d.canvas.ctx.lineWidth = d.particles.line_linked.width, d.canvas.ctx.beginPath(), d.canvas.ctx.moveTo(e.x, e.y), d.canvas.ctx.lineTo(t.x, t.y), d.canvas.ctx.stroke(), d.canvas.ctx.closePath()
            }
        }
        ...
        d.tmp.pushing = !0;
        for (var i = 0; i < e; i++) d.particles.array.push(new d.fn.particle(d.particles.color, d.particles.opacity.value, {
        ...
        if (d.interactivity.events.onhover.enable && isInArray("bubble", d.interactivity.events.onhover.mode)) {
            ...
            d.tmp.bubble_clicking && (t(d.interactivity.modes.bubble.size, d.particles.size.value, a.radius_bubble, a.radius, "size"), t(d.interactivity.modes.bubble.opacity, d.particles.opacity.value, a.opacity_bubble, a.opacity, "opacity"))
        }
        ...
        if (d.interactivity.events.onhover.enable && "mousemove" == d.interactivity.status) {
            ...
            if (n <= d.interactivity.modes.grab.distance) {
                ...
                if (0 < r) {
                    ...
                    d.canvas.ctx.strokeStyle = "rgba(" + o.r + "," + o.g + "," + o.b + "," + r + ")", d.canvas.ctx.lineWidth = d.particles.line_linked.width, d.canvas.ctx.beginPath(), d.canvas.ctx.moveTo(e.x, e.y), d.canvas.ctx.lineTo(d.interactivity.mouse.pos_x, d.interactivity.mouse.pos_y), d.canvas.ctx.stroke(), d.canvas.ctx.closePath()
                }
            }
        }
        ...
        "window" == d.interactivity.detect_on ? d.interactivity.el = window : d.interactivity.el = d.canvas.el, (d.interactivity.events.onhover.enable || d.interactivity.events.onclick.enable) && (d.interactivity.el.addEventListener("mousemove", function(e) {
            ...
            d.interactivity.mouse.pos_x = t, d.interactivity.mouse.pos_y = i, d.tmp.retina && (d.interactivity.mouse.pos_x *= d.canvas.pxratio, d.interactivity.mouse.pos_y *= d.canvas.pxratio), d.interactivity.status = "mousemove"
...
var getYTPVideoID = function(e) {
    var t, i;
    return 0 < e.indexOf("youtu.be") ? t = (i = 0 < (t = e.substr(e.lastIndexOf("/") + 1, e.length)).indexOf("?list=") ? t.substr(t.lastIndexOf("="), t.length) : null) ? t.substr(0, t.lastIndexOf("?")) : t : -1 < e.indexOf("http") ? (t = e.match(/[\\?&]v=([^&#]*)/)[1], i = 0 < e.indexOf("list=") ? e.match(/[\\?&]list=([^&#]*)/)[1] : null) : i = (t = 15 < e.length ? null : e) ? null : e, {
        videoID: t,
        playlistID: i
    }
};
...
function setFilter(e, t, i) {
    ...
    jQuery.mbYTPlayer = {
        ...
        play: function() {
            ...
            return e.isReady && (e.player.playVideo(), e.wrapper.CSSAnimate({
                ...
                opacity: 1
            }, 1e3), jQuery("#controlBar_" + e.id).find(".mb_YTPPlaypause").html(jQuery.mbYTPlayer.controls.pause), e.state = 1, jQuery(e).css("background-image", "none")), this
        },
        ...
        removeFilter: function(t, i) {
            return this.each(function() {
                if ("function" == typeof t && (i = t, t = null), t) jQuery(this).YTPApplyFilter(t, 0), "function" == typeof i && i(t);
                    ...
                    for (var e in this.filters) jQuery(this).YTPApplyFilter(e, 0), "function" == typeof i && i(e)
            })
        },
        getFilters: function() {
        ...
        checkForStart: function(n) {
            ...
            if (jQuery.contains(document, n)) {
                if (n.preventTrigger = !0, n.state = 2, jQuery(n).YTPPause(), jQuery(n).muteYTPVolume(), jQuery("#controlBar_" + n.id).remove(), n.controlBar = !1, n.opt.showControls && jQuery.mbYTPlayer.buildControls(n), n.opt.addRaster) {
                    var e = "dot" == n.opt.addRaster ? "raster-dot" : "raster";
                    n.overlay.addClass(n.isRetina ? e + " retina" : e)
                } else n.overlay.removeClass(function(e, t) {
                    var i = t.split(" "),
                        n = [];
                ...
                n.player.playVideo(), n.player.seekTo(o, !0), n.checkForStartAt = setInterval(function() {
                    jQuery(n).YTPMute();
                    ...
                    if (0 < n.player.getDuration() && n.player.getCurrentTime() >= o && e) {
                        ...
                        if (t.time = n.currentTime, jQuery(n).trigger(t), n.preventTrigger = !0, n.state = 2, jQuery(n).YTPPause(), n.opt.mute || jQuery(n).YTPUnmute(), n.canTrigger = !0, n.opt.autoPlay) {
                            ...
                            i.time = n.currentTime, jQuery(n).trigger(i), r.css("background-image", "none"), jQuery(n.playerEl).CSSAnimate({
                                opacity: 1
                            }, 1e3), r.YTPPlay(), n.wrapper.CSSAnimate({
                                opacity: n.isAlone ? 1 : n.opt.opacity
                            }, 1e3), jQuery.browser.safari && (n.safariPlay = setInterval(function() {
                                1 != n.state ? r.YTPPlay() : clearInterval(n.safariPlay)
                            }, 10)), r.on("YTPReady", function() {
                                r.YTPPlay()
                            })
                        } else n.player.pauseVideo(), n.isPlayer || (jQuery(n.playerEl).CSSAnimate({
                            opacity: 1
                        }, 500), n.wrapper.CSSAnimate({
                            opacity: n.isAlone ? 1 : n.opt.opacity
                        }, 500)), n.controlBar.length && n.controlBar.find(".mb_YTPPlaypause").html(jQuery.mbYTPlayer.controls.play);
                        n.isPlayer && !n.opt.autoPlay && n.loading && n.loading.length && (n.loading.html("Ready"), setTimeout(function() {
                            n.loading.fadeOut()
                        }, 100)), n.controlBar && n.controlBar.length && n.controlBar.slideDown(1e3)
        ...
        if (t.opt.optimizeDisplay) {
            var o = {},
                s = t.wrapper;
            o.width = s.outerWidth(), o.height = s.outerHeight(), n.width = o.width, n.height = "16/9" == t.opt.ratio ? Math.ceil(o.width * (9 / 16)) : Math.ceil(.75 * o.width), n.width = o.width, n.height = "16/9" == t.opt.ratio ? Math.ceil(o.width * (9 / 16)) : Math.ceil(.75 * o.width), n.marginTop = -(n.height - o.height) / 2, n.marginLeft = 0;
    ...
    animate: function(u, h, p, d, f) {
        return this.each(function() {
            function e() {
                t.called = !0, t.CSSAIsRunning = !1, i.off(jQuery.CSS.transitionEnd + "." + t.id), clearTimeout(t.timeout), i.css(jQuery.CSS.sfx + "transition", ""), "function" == typeof f && f.apply(t), "function" == typeof t.CSSqueue && (t.CSSqueue(), t.CSSqueue = null)
            }
            var t = this,
                i = jQuery(this);
            ...
            if (t.CSSAIsRunning && t.eventType == n.type && !jQuery.browser.msie && jQuery.browser.version <= 9) t.CSSqueue = function() {
                ...
                if (u = jQuery.normalizeCss(u), t.CSSAIsRunning = !0, "function" == typeof h && (f = h, h = jQuery.fx.speeds._default), "function" == typeof p && (d = p, p = 0), "string" == typeof p && (f = p, p = 0), "function" == typeof d && (f = d, d = "cubic-bezier(0.65,0.03,0.36,0.72)"), "string" == typeof h)
                ...
                var l = jQuery.CSS.getProp(u),
                    c = {};
                jQuery.extend(c, u), c[jQuery.CSS.sfx + "transition-property"] = l, c[jQuery.CSS.sfx + "transition-duration"] = h + "ms", c[jQuery.CSS.sfx + "transition-delay"] = p + "ms", c[jQuery.CSS.sfx + "transition-timing-function"] = d, setTimeout(function() {
                    i.one(jQuery.CSS.transitionEnd + "." + t.id, e), i.css(c)
                }, 1), t.timeout = setTimeout(function() {
                    return t.called || !f ? (t.called = !1, void(t.CSSAIsRunning = !1)) : (i.css(jQuery.CSS.sfx + "transition", ""), f.apply(t), t.CSSAIsRunning = !1, void("function" == typeof t.CSSqueue && (t.CSSqueue(), t.CSSqueue = null)))
                }, h + p + 10)
            }
        })
    }
...
jQuery.browser.android = /Android/i.test(nAgt), jQuery.browser.blackberry = /BlackBerry|BB|PlayBook/i.test(nAgt), jQuery.browser.ios = /iPhone|iPad|iPod|webOS/i.test(nAgt), jQuery.browser.operaMobile = /Opera Mini/i.test(nAgt), jQuery.browser.windowsMobile = /IEMobile|Windows Phone/i.test(nAgt), jQuery.browser.kindle = /Kindle|Silk/i.test(nAgt), jQuery.browser.mobile = jQuery.browser.android || jQuery.browser.blackberry || jQuery.browser.ios || jQuery.browser.windowsMobile || jQuery.browser.operaMobile || jQuery.browser.kindle, jQuery.isMobile = jQuery.browser.mobile, jQuery.isTablet = jQuery.browser.mobile && 765 < jQuery(window).width(), jQuery.isAndroidDefault = jQuery.browser.android && !/chrome/i.test(nAgt),
    function(o) {
        var s = (/iphone|ipod|ipad|android|ie|blackberry|fennec/.test(navigator.userAgent.toLowerCase()), "ontouchstart" in window || window.navigator && window.navigator.msPointerEnabled && window.MSGesture || window.DocumentTouch && document instanceof DocumentTouch || !1);
        o.simpleSlider = {
            defaults: {
                initialval: 0,
                scale: 100,
            ...
            init: function(r) {
                return this.each(function() {
                    ...
                    i.prepend(n), t.level = n, i.css({
                        cursor: "default"
                    }), "auto" == t.opt.scale && (t.opt.scale = o(t).outerWidth()), i.updateSliderVal(), t.opt.readonly || (i.on(o.simpleSlider.events.start, function(e) {
                        s && (e = e.changedTouches[0]), t.canSlide = !0, i.updateSliderVal(e), i.css({
                            cursor: "col-resize"
                        }), e.preventDefault(), e.stopPropagation()
                    }), o(document).on(o.simpleSlider.events.move, function(e) {
                        s && (e = e.changedTouches[0]), t.canSlide && (o(document).css({
                            cursor: "default"
                        }), i.updateSliderVal(e), e.preventDefault(), e.stopPropagation())
